...
from .views import register, login_view, logout_view, dashboard, bsc_data_api, bsc_detailed_view, delete_bsc_data, delete_batch, update_batch, profile_view, add_viewer, delete_viewer, batch_details_api
